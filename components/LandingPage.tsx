...
const steps = [
  ...
  },
  {
    number: '02',
    icon: '✨',
    title: 'Stockleがサクッと整理',
    desc: 'カテゴリに仕分け・キーワード抽出・要約を\nあっという間にやってくれます',
  },
  {
    number: '03',
    icon: '🌌',
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-6">
          {[
            {
              icon: '🔬',
              title: 'ごちゃごちゃを勝手に整理してくれる',
              desc: '科学・技術・歴史・社会・芸術の5つに仕分けして、長いギモンも200字にまとめます。',
            },
            {
              icon: '🌌',
              title: 'あなたってどういう人？がわかる',
              desc: '記録が増えるほど、自分の好奇心のかたちがグラフと星空で見えてきます。',
            },
            {
              icon: '🧠',
              title: 'あなただけのキャラ診断みたいなもの',
              desc: 'ギモンが集まると「あなたってこういう人っぽい」をStockleがこっそり教えます。',
            },
            {
              icon: '📱',
              title: 'スマホでもサクサク',
